...
! Create file 
write(SL_log_file,'(a,i0)') trim(file_head)//'SL.log'
...
use serial_library
    ...
    write( SLlogunit,*)'  --> Mass change    :    ', SLmasschange
