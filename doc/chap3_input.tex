...
\item[sealevel:]  information for sea level simulation
...
In this file any lines beginning with '#' as the first character are considered
to be comment lines and are ignored. The information format for this file (ignoring) any comment lines) is: 

line 1: \emph{cartesian or global}: integer value 1 = Cartesian, 2 = Global 
line 2: \emph{type of initial SL}: integer value 0 = defined by constant Z value - only for cartesian SL simulation 
line 3: \emph{initial sea level} See full description below


\underline{initial sea level (line 3):}
Different formats are used based on the input: 

if line2 = 0: Sea level is defined by constant Z value. In this case line 3 is the Z value.